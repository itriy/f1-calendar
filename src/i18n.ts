...
const messages = {
  uk: {
    ...
    history: { eyebrow: 'АРХІВ · JOLPICA-F1', title: 'Історія етапів', currentDescription: 'Усі вже завершені гонки сезону. Останній етап деталізовано окремою карткою вище.', description: 'Усі завершені гонки сезону {season} та їхні переможці.', driverLeader: 'ЛІДЕР ПІЛОТІВ', driverChampion: 'ЧЕМПІОН ПІЛОТІВ', constructorLeader: 'ЛІДЕР КОМАНД', constructorChampion: 'ЧЕМПІОН КОМАНД', summaryLoading: 'Завантажуємо підсумок…', summaryUnavailable: 'Підсумок недоступний.', loading: 'Завантажуємо історію завершених етапів…', winnerMissing: 'Переможця не вказано', podium: 'ПОДІУМ · ВІДСТАВАННЯ ВІД ПЕРЕМОЖЦЯ', detailsLoading: 'Завантажуємо класифікацію етапу…', detailsUnavailable: 'Класифікація етапу недоступна.', videosTitle: 'ОФІЦІЙНІ ВІДЕО F1', videosLoading: 'Шукаємо офіційні відео Formula 1…', videosShowAll: 'ПОКАЗАТИ ВСІ ВІДЕО ({count})', videosCollapse: 'ЗГОРНУТИ ВІДЕО', raceHighlights: 'Race Highlights', qualifyingHighlights: 'Qualifying Highlights', sprintHighlights: 'Sprint Highlights', raceMoment: 'Ключовий момент', youtubeChannel: 'КАНАЛ FORMULA 1 ↗', videosUnavailable: 'Відео ще не знайдено для «{race}». Перевірте пізніше.', collapse: 'ЗГОРНУТИ АРХІВ', showMore: 'ПОКАЗАТИ ЩЕ {count}', currentEmpty: 'Завершених етапів у поточному сезоні поки немає.', empty: 'Для сезону {season} завершених етапів не знайдено.' },
    ...
    reminders: { eyebrow: 'PUSH', title: 'Нагадування про гонку', description: 'Сповіщення надсилаються за запланованим UTC-часом календаря: за 1 день, за 1 годину або в момент запланованого старту. На сайті час етапу показано у вашому часовому поясі. Це не підтвердження фактичного старту гонки.', legend: 'Коли нагадувати', day: 'За 1 день', hour: 'За 1 годину', start: 'У момент старту', unsupported: 'Web Push недоступний у цьому браузері. На iPhone/iPad спершу встановіть застосунок на екран «Початок».', permissionDeniedTitle: 'Сповіщення заблоковано', permissionDenied: 'Браузер не може повторно показати системний запит, доки ви не зміните дозвіл для цього сайту.', permissionStepOne: 'Натисніть значок налаштувань або замка біля адреси сторінки.', permissionStepTwo: 'Відкрийте налаштування сайту й для «Сповіщень» виберіть «Дозволити».', permissionStepThree: 'Поверніться сюди та натисніть «Перевірити дозвіл».', checkPermission: 'Перевірити дозвіл', wait: 'Зачекайте…', enable: 'Увімкнути нагадування', save: 'Зберегти вибір', disable: 'Вимкнути', enableDenied: 'Дозвіл на сповіщення відхилено в браузері.', enableUnsupported: 'Цей браузер не підтримує Web Push.', enabled: 'Нагадування увімкнено.', enableError: 'Не вдалося увімкнути нагадування.', saved: 'Налаштування збережено.', saveError: 'Не вдалося зберегти налаштування.', disabled: 'Нагадування вимкнено.', disableError: 'Не вдалося вимкнути нагадування.' },
