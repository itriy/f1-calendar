...
<template>
  <main class="min-h-screen overflow-hidden">
    ...
    <template v-else>
      ...
      <section class="mx-auto w-[min(1180px,calc(100%-28px))] pb-10 lg:w-[min(1180px,calc(100%-48px))]"><AiSearch /></section>
    </template>
